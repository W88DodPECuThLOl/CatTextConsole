...
class CatKey {
	 ...
	 * @returns {number_Or_string} 変換したキーコード
	 */
	...
	/**
	 * キーバッファに入れる
	 * @param {number_or_string} keyCode キーコード
	...
	/**
	 * キーバッファから取得する
	 * @returns {number_Or_string} キーコード。キーバッファが空なら、空の文字列を返す
	 */
	dequeueKeyBuffer() {
	 ...
	 * @returns {number_OR_string} キーコード。押下されていなかったら0を返す。
	 */
	inKey() {
		if(this.#lastKeyCode
